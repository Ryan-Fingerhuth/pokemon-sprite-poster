...
export class PokemonConstants {
  ...
  public generations: IPokemonGenerationInfo[] = [
    <IPokemonGenerationInfo>{
      generation: 'Gen 1',
      versions: ['Red/Blue', 'Red/Green', 'Yellow', 'Leaf Green/Fire Red'],
      dexOptions: ['Kanto'],
    },
    <IPokemonGenerationInfo>{
      generation: 'Gen 2',
      versions: ['Gold', 'Silver', 'Crystal'],
      dexOptions: ['Johto', 'National'],
    },
    <IPokemonGenerationInfo>{
      generation: 'Gen 3',
      versions: ['Ruby/Sapphire', 'Emerald'],
      dexOptions: ['Hoenn', 'National'],
    },
    <IPokemonGenerationInfo>{
      generation: 'Gen 4',
      versions: ['Diamond/Pearl/Platinum'],
      dexOptions: ['Sinnoh', 'National'],
    },
    <IPokemonGenerationInfo>{
      generation: 'Gen 5',
      versions: ['Black/White'],
      dexOptions: ['Unova', 'National'],
    },
  ];
}
